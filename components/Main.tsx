...
const Main = () => {
  return (
    <section className="bg-[url('/desert.jpg')] bg-no-repeat bg-center bg-cover h-full w-full  p-0 sm:p-10 max-sm:py-10 my-0">
        ...
        <div className="flex max-lg:flex-col items-center justify-between max-lg:mb-10 mt=20 ">
          ...
          <div className="flex flex-col items-end justify-center gap-5 max-lg:items-center">
            ...
            <RedirectButton path="register">
              <Button
                size="lg"
                className="rounded-xl bg-gray-200 opacity-60 text-black font-black hover:bg-gray-100 duration-200 w-[10rem] z-0"
              >
                سجل اللآن
              </Button>
            </RedirectButton>
